...
co=False
def key(event):
    global v,can,M,mx,my,mar,est,ya,co,ya2,sy,sx,soc,est2
...
def key2(event):
    ...
    if(tecla == "'4'" and ((sx > 75 and sy==425)or(sx>5 and sy==315)or(sx>5 and sy==205)or(sx>=100 and sy==100)) and ya2 == False):
        sx -= 15
        soc.destroy()
        if(est2!=0):
            ...
            soc.place(x=sx,y=sy)
            est2=1
    if(tecla == "'6'" and ((sx <450 and sy==425)or(sx<500 and sy==315)or(sx<500 and sy==205)or (sx<=400 and sy==100)) and ya2 == False):
        sx += 15
        soc.destroy()
        if(est2!=5):
