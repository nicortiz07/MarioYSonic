...
def Enemigos():
    ...
    while x < len(E):
        if(E[x][0] <= 3):
            ...
            # Matar enemigos
            if(E[x][3]==1):
                if(E[x][2] + 65 >= my and E[x][2] + 30 <= my and E[x][1] <= mx + 30 and E[x][1] + 30 >= mx and ya == True)or(E[x][2] + 65 >= sy and E[x][2] + 30 <= sy and E[x][1] <= sx + 30 and E[x][1] + 30 >= sx and ya2 == True):
                    E[x][0] = 5
            if(E[x][0]==5):
                E[x][4].destroy()
